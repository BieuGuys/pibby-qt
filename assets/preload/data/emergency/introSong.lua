...
IntroTagColor = '0024DD'	--Color of the tag at the end of the box.
IntroTagWidth = 70	--Width of the box's tag thingy.
--easy script configs
...
function onCreate()
	...
	makeLuaText('JukeBoxText', 'Song By Christopher / DULAM Pictures', 300, -305-IntroTagWidth, 30)
	...
	makeLuaText('JukeBoxSubText', songName, 600, -380-IntroTagWidth, 85)
